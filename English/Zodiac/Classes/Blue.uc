...
// Blue.
//=============================================================================
class Blue extends Animal;

#exec TEXTURE IMPORT NAME=BlueAlienTex FILE=Textures\BlueAlienTex.pcx GROUP=Skins
...
defaultproperties
{
     bPlayDying=True
     MinHealth=10.000000
     CarcassType=Class'Zodiac.BlueCarcass'
     ...
     DrawScale=0.750000
     MultiSkins(0)=Texture'Zodiac.Skins.BlueAlienTex'
     CollisionRadius=21.400000
