...
// MutantKarkian.
//=============================================================================
class MutantKarkian extends Animal;

#exec TEXTURE IMPORT NAME=MutantKarkianTex FILE=Textures\MutantKarkianTex.pcx GROUP=Skins
...
{
	PlaySound(sound'KarkianIdle', SLOT_None,,,,160);
}
...
defaultproperties
{
     ...
     bMessyEater=True
     MinHealth=50.000000
     CarcassType=Class'Zodiac.MutantKarkianCarcass'
     ...
     DrawScale=1.700000
     MultiSkins(0)=Texture'Zodiac.Skins.MutantKarkianTex'
     CollisionRadius=91.800003
     CollisionHeight=63.070000
     Mass=850.000000
     Buoyancy=500.000000
     RotationRate=(Yaw=30000)
     BindName="MutantKarkian"
     FamiliarName="Mutant Karkian"
     UnfamiliarName="Mutant Karkian"
}
