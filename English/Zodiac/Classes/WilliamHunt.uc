class WilliamHunt extends HumanCivilian;

defaultproperties
{
     CarcassType=Class'Zodiac.WilliamHuntCarcass'
     ...
     BindName="WilliamHunt"
     FamiliarName="William Hunt"
     UnfamiliarName="William Hunt"
}
