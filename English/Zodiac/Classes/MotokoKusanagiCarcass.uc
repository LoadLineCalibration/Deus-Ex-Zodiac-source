//=============================================================================
// MotokoKusanagiCarcass.
//=============================================================================
class MotokoKusanagiCarcass extends DeusExCarcass;
...
defaultproperties
{
     ...
     MultiSkins(3)=Texture'Zodiac.Skins.CoolFramesTex1'
     ...
     MultiSkins(7)=Texture'DeusExCharacters.Skins.SarahMeadTex1'
}
